package com.hello.jpa.ex;

import com.hello.jpa.JpaInit;
import com.hello.jpa.ex.service.JpaService;
...
//        EntityManagerFactory emf = Persistence.createEntityManagerFactory("hello");
        ...
        EntityManagerFactory emf = JpaInit.getInstance().getFactory("hello");
